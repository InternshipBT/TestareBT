...
public class AssertOnPriceAscendingOrder {
    ...
    @Test
    public void AssertOnPriceAscendingOrderTest(){
        madisonLoginSteps.openPageMadison();
        madisonLoginSteps.loginMadison(MADISON_EMAIL, MADISON_PASSWORD);
        madisonAddInBasketSteps.searchProduct("pants");
        madisonAddInBasketSteps.sortAscendingPriceList();
        madisonAddInBasketSteps.selectPriceFromDropdown();
        madisonAddInBasketSteps.assertPriceAscending();
